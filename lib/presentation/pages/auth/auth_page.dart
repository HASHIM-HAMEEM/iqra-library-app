...
class _AuthPageState extends ConsumerState<AuthPage>
  ...
  bool get _inTest => const bool.fromEnvironment('FLUTTER_TEST');
    ...
    try {
      if (kIsWeb) {
        ...
        if (AppConfig.developerMode && mounted) {
          setState(() => _biometricWhyHidden = 'Biometrics unavailable on web');
        }
        return;
      }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              _brandFeature(Icons.download_rounded, 'Excel & CSV data export'),
            ],
          ),
        ),
      ),
              ...
              children: [
                ...
                if (_biometricAvailable) ...[
                  ...
                  IconButton(
                    ...
                    onPressed:
                        (ref.read(authProvider).isLoading || _authInProgress)
                        ? null
                        : _authenticateWithBiometric,
                  ...
                  if (_biometricAvailable) ...[
                    ...
                    OutlinedButton.icon(
                      ...
                      icon: _authInProgress
                          ...
                          : const Icon(Icons.fingerprint_rounded),
                      label: Text(
                        _authInProgress ? 'Authenticating…' : 'Use Biometric',
                      ),
